...
Sepal.Length <- with(originalData, tapply(Sepal.Length, Species, mean))
Sepal.Width <- with(originalData, tapply(Sepal.Width, Species, mean))
Petal.Length <- with(originalData, tapply(Petal.Length, Species, mean))
Petal.Width<- with(originalData, tapply(Petal.Width, Species, mean))
